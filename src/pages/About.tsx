      ...
      <div className="lg:w-1/2 flex flex-col-reverse lg:flex-col justify-center gap-8 px-6 lg:px-12 pb-10">
        ...
        <div className="text-pf-black-01 font-sans text-start max-w-xl">
          ...
          <p className="text-sm">
            ...
            laoreet nisl, non lacinia lorem. Nunc dictum urna ut massa auctor
            malesuada. Ut iaculis vestibulum sem at tempus. Sed laoreet magna
            sit amet vulputate efficitur. Vivamus mattis dapibus nulla vel
            interdum. Integer sit amet ultricies magna. Fusce ac varius magna.
            Nunc rutrum aliquet rhoncus.
          </p>
        </div>
      </div>
    </div>
